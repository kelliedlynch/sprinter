<template>
  <v-sheet class="pa-0" :height="logoHeight" :width="logoWidth">
    <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" :width="logoWidth" :height="logoHeight" viewBox="0 0 108.06 98.78">
